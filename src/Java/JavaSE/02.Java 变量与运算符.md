...
![image-20230418321134411](./assets/image-20230418321134411.png)
...
![image-20230416214455134](./assets/image-20230416214455134.png)
...
![image-20230416214505006](./assets/image-20230416214505006.png)

![image-20230416214508505](./assets/image-20230416214508505.png)
...
![image-20230416214547385](./assets/image-20230416214547385.png)

一花一世界，如果把一个程序看做一个世界或一个社会的话，那么变量就是程序世界的花花草草、万事万物。即，**变量是程序中不可或缺的组成单位，最基本的存储单元**。

![image-20230416214551271](./assets/image-20230416214551271.png)
...
- 变量的概念：
  ...
  - Java 中变量声明的格式：`数据类型 变量名 = 变量值`
    ...
    ![image-20230416214556224](./assets/image-20230416214556224.png)
...
- **引用数据类型**：包括`数组`、 `类`、`接口`、`枚举`、`注解`、`记录`。 
  ...
  ![image-20230416214602658](./assets/image-20230416214602658.png)
...
![image-20230416214616649](./assets/image-20230416214616649.png)

## ✨基本数据类型介绍

### 整数类型：byte、short、int、long

![image-20230416214648536](./assets/image-20230416214648536.png)

- Java 各整数类型有固定的表数范围和字段长度，不受具体操作系统的影响，以保证 Java 程序的可移植性。

![image-20230416214652156](./assets/image-20230416214652156.png)
...
![image-20230416214703125](./assets/image-20230416214703125.png)
...
![image-20230416214719941](./assets/image-20230416214719941.png)

基本数据类型的转换规则如图所示：

![image-20230416214724246](./assets/image-20230416214724246.png)
...
![image-20230416214730147](./assets/image-20230416214730147.png)
...
- 声明方式与基本数据类型类似。例如：String str = “klrss”;
...
![image-20230417124458173](./assets/image-20230417124458173.png)
...
![image-20230416214751337](./assets/image-20230416214751337.png)

记忆技巧：

![image-20230417125718287](./assets/image-20230417125718287.png)

我们偶尔会看到的：SOS，即为：

![image-20230416214801277](./assets/image-20230416214801277.png)
...
![image-20230416214806255](./assets/image-20230416214806255.png)
...
![image-20230416214813516](./assets/image-20230416214813516.png)

### 二进制与八进制、十六进制间的转换

**二进制转八进制**

![image-20230416214817737](./assets/image-20230416214817737.png)

**二进制转十六进制**

![image-20230416214829055](./assets/image-20230416214829055.png)

**八进制、十六进制转二进制**

![image-20230416214832620](./assets/image-20230416214832620.png)

### 各进制间的转换

![image-20230416214836894](./assets/image-20230416214836894.png)
...
![image-20230416214848016](./assets/image-20230416214848016.png)
...
![image-20230416214932983](./assets/image-20230416214932983.png)
...
![image-20230416214941270](./assets/image-20230416214941270.png)
...
![image-20230416214952485](./assets/image-20230416214952485.png)

![image-20230416214955851](./assets/image-20230416214955851.png)
...
![image-20230416215002753](./assets/image-20230416215002753.png)

```java
-3<<4  类似于  -3*2的4次幂 => -3*16 => -48
```

![image-20230416215006694](./assets/image-20230416215006694.png)
...
![image-20230416215012703](./assets/image-20230416215012703.png)

```
-69>>4  类似于  -69/2的4次 = -69/16 = -5
```

![image-20230416215016601](./assets/image-20230416215016601.png)
...
![image-20230416215021088](./assets/image-20230416215021088.png)

```
-69>>>4   结果：268435451
```

![image-20230416215024392](./assets/image-20230416215024392.png)
...
![image-20230416215037794](./assets/image-20230416215037794.png)

```java
-9 & 7 = 7
```

![image-20230416215040866](./assets/image-20230416215040866.png)
...
![image-20230416215045776](./assets/image-20230416215045776.png)

```java
-9 | 7 //结果： -9
```

![image-20230416215049861](./assets/image-20230416215049861.png)
...
![image-20230416215053648](./assets/image-20230416215053648.png)

```java
-9 ^ 7 //结果为 -16
```

![image-20230416215057309](./assets/image-20230416215057309.png)
...
![image-20230416215101969](./assets/image-20230416215101969.png)

```java
~-9  //结果：8
```

![image-20230416215105266](./assets/image-20230416215105266.png)

#### 举例

**举例 1：**

![image-20230416215111914](./assets/image-20230416215111914.png)

**举例 2：体会 m = k ^ n = (m ^ n) ^ n**

![image-20230416215117555](./assets/image-20230416215117555.png)
...
- 说明：条件表达式是 boolean 类型的结果，根据 boolean 的值选择表达式 1 或表达式 2
  ...
  ![image-20230416215125218](./assets/image-20230416215125218.png)
...
![image-20230416215141885](./assets/image-20230416215141885.png)
...
![image-20230416215152570](./assets/image-20230416215152570.png)

### 小结

![image-20230416215155904](./assets/image-20230416215155904.png)
