...
![image-20230417094407824](./assets/image-20230417094407824.png)
...
![image-20230417094749847](./assets/image-20230417094749847.png)
...
![image-20230417094800282](./assets/image-20230417094800282.png)

- 简图 1：**Collection 接口继承树**

![image-20230417094803950](./assets/image-20230417094803950.png)

- 简图 2：**Map 接口继承树**

![image-20230417094808967](./assets/image-20230417094808967.png)

### 集合的使用场景

![image-20230417094812945](./assets/image-20230417094812945.png)

![image-20230417094816552](./assets/image-20230417094816552.png)
...
![image-20230417094825371](./assets/image-20230417094825371.png)
...
![image-20230417094926031](./assets/image-20230417094926031.png)
...
![image-20230417094950823](./assets/image-20230417094950823.png)
...
![image-20230417095002993](./assets/image-20230417095002993.png)
...
- Arrays.asList(…) 方法返回的 List 集合，既不是 ArrayList 实例，也不是 Vector 实例。Arrays.asList(…) 返回值是一个固定长度的 List 集合
  ...
  ![image-20230417095013005](./assets/image-20230417095013005.png)

### List 的实现类之二：LinkedList

- 对于频繁的插入或删除元素的操作，建议使用 LinkedList 类，效率较高。这是由底层采用链表（双向链表）结构存储数据决定的。

![image-20230417095016241](./assets/image-20230417095016241.png)
...
* 代码实现，效果如图所示：
  ...
  ![image-20230417095024514](./assets/image-20230417095024514.png)
...
![image-20230417095033976](./assets/image-20230417095033976.png)
...
![image-20230417095103751](./assets/image-20230417095103751.png)
...
- Map 接口的常用实现类：`HashMap`、`LinkedHashMap`、`TreeMap`和``Properties`。其中，HashMap是 Map 接口使用`频率最高`的实现类。
  ...
  ![image-20230417095132696](./assets/image-20230417095132696.png)

### Map 中 key-value 特点

这里主要以 HashMap 为例说明。HashMap 中存储的 key、value 的特点如下：

![image-20230417095138145](./assets/image-20230417095138145.png)

- Map 中的 `key用Set来存放`，`不允许重复`，即同一个 Map 对象所对应的类，须重写 hashCode() 和 equals() 方法

  ![image-20230417095141864](./assets/image-20230417095141864.png)
...
![image-20230417095158129](./assets/image-20230417095158129.png)
...
![image-20230417095210811](./assets/image-20230417095210811.png)
 ...
 * @version 
 * @date 2021 年 5 月 7 日上午 12:26:59
 *
 */
class CityMap{
...
![image-20230417095238287](./assets/image-20230417095238287.png)
...
![image-20230417095251263](./assets/image-20230417095251263.png)
...
![image-20230417095302958](./assets/image-20230417095302958.png)
