...
![image-20230417095302959](./assets/image-20230417095302959.png)
...
- String 对象的字符内容是存储在一个字符数组 value[]中的。`"abc"` 等效于 `char[] data={'h','e','l','l','o'}`。
  ...
  ![image-20230417100136292](./assets/image-20230417100136292.png)
...
![image-20230417100143546](./assets/image-20230417100143546.png)
...
![image-20230417100148056](./assets/image-20230417100148056.png)

进一步：

![image-20230417100151544](./assets/image-20230417100151544.png)
...
![image-20230417100155006](./assets/image-20230417100155006.png)

#### 练习类型 2：new

String str1 = “abc”; 与 String str2 = new String(“abc”);的区别？

![image-20230417100158845](./assets/image-20230417100158845.png)
...
![image-20230417100203150](./assets/image-20230417100203150.png)
...
- java.lang.StringBuffer 代表`可变的字符序列`，JDK1.0 中声明，可以对字符串内容进行增删，此时不会产生新的对象。比如：
  ...
  ![image-20230417100235157](./assets/image-20230417100235157.png)

![image-20230417100240294](./assets/image-20230417100240294.png)


- 继承结构：


![image-20230417100244666](./assets/image-20230417100244666.png)

![image-20230417100249883](./assets/image-20230417100249883.png)
...
>
>   ![image-20230417100301479](./assets/image-20230417100301479.png)
...
![image-20230417100318140](./assets/image-20230417100318140.png)
...
![image-20230417100323627](./assets/image-20230417100323627.png)
...
- 获取 Calendar 实例的方法
  ...
  - 使用`Calendar.getInstance()`方法
    ...
    ![image-20230417100328097](./assets/image-20230417100328097.png)

  - 调用它的子类 GregorianCalendar（公历）的构造器。

    ![image-20230417100331451](./assets/image-20230417100331451.png)
...
- 常用字段
  ...
  ![image-20230417100335946](./assets/image-20230417100335946.png)
...
![image-20230417100341421](./assets/image-20230417100341421.png)
...
![image-20220406000442908](./assets/image-20230417100349725.png)
...
![image-20230417100404455](./assets/image-20230417100404455.png)
...
- 成员方法
  ...
  - `String getProperty(String key)`：
    ...
    ![image-20230417100432683](./assets/image-20230417100432683.png)
