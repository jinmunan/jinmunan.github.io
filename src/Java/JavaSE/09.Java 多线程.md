...
![image-20230417101407637](./assets/image-20230417101407637.png)

***

我们之前学习的程序在没有跳转语句的情况下，都是由上至下沿着一条路径依次执行。现在想要设计一个程序，可以同时有多条执行路径同时执行。比如，`一边游戏，一边qq聊天，一边听歌`，怎么设计？

![image-20230417101934855](./assets/image-20230417101934855.png)
...
* **线程（thread）**：进程可进一步细化为线程，是程序内部的`一条执行路径`。一个进程中至少有一个线程。
  ...
  - 一个进程同一时间若`并行`执行多个线程，就是支持多线程的。
    ...
    ![image-20230417102210450](./assets/image-20230417102210450.png)
  ...
  ![image-20230417102215382](./assets/image-20230417102215382.png)
...
![image-20230417102219952](./assets/image-20230417102219952.png)

2、一个应用程序的多次运行，就是多个进程

![image-20230417102223868](./assets/image-20230417102223868.png)

3、一个进程中包含多个线程

![image-20230417102229158](./assets/image-20230417102229158.png)
...
- **抢占式调度**
  ...
  ![image-20230417123216298](./assets/image-20230417123216298.png)
...
* **并行（parallel）**：指两个或多个事件在`同一时刻`发生（同时发生）。指在同一时刻，有`多条指令`在`多个CPU`上`同时`执行。比如：多个人同时做不同的事。
  ...
  ![image-20230417102240065](./assets/image-20230417102240065.png)

  ![image-20230417102244681](./assets/image-20230417102244681.png)

* **并发（concurrency）**：指两个或多个事件在`同一个时间段内`发生。即在一段时间内，有`多条指令`在`单个CPU`上`快速轮换、交替`执行，使得在宏观上具有多个进程同时执行的效果。

  ![image-20230417102248200](./assets/image-20230417102248200.png)

  ![image-20230417102251589](./assets/image-20230417102251589.png)
...
![image-20230417102258436](./assets/image-20230417102258436.png)
...
![image-20230417102307792](./assets/image-20230417102307792.png)
...
![image-20230417102321354](./assets/image-20230417102321354.png)
...
![image-20230417102329801](./assets/image-20230417102329801.png)
...
![image-20230417102338756](./assets/image-20230417102338756.png)

或

![image-20230417102342237](./assets/image-20230417102342237.png)
...
![image-20230417102348610](./assets/image-20230417102348610.png)
...
![image-20230417102352467](./assets/image-20230417102352467.png)



类比：

![gif-1681708986826-9](./assets/gif-1681708986826-9.gif)
...
![image-20230417102415084](./assets/image-20230417102415084.png)
...
![image-20230417102431523](./assets/image-20230417102431523.png)
...
![image-20230417102451186](./assets/image-20230417102451186.png)
