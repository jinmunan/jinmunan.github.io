...
![image-20230419153821128](./assets/image-20230419153821128.png)
...
![image-20230419153927103](./assets/image-20230419153927103.png)
...
//方式 1 分析
//1. 简单，比较容易想到
//2. 如果我们获取的对象是 微信，短信等等，则新增类，同时 Persons 也要增加相应的接收方法
...
![image-20230420083236250](./assets/image-20230420083236250.png)
...
public class Liskov {
    ...
    public static void main(String[] args) {
        ...
        //调用完成的功能就会很明确
        System.out.println("11+3=" + b.func1(11, 3));//11+3 这里本意是求出 11+3
        System.out.println("1+8=" + b.func1(1, 8));// 1+8
        System.out.println("11+3+9=" + b.func2(11, 3));
...
![image-20230420084052113](./assets/image-20230420084052113.png)
...
- 比如我们这时要新增加一个图形种三角形，我们需要做如下修改，修改的地方较多
...
![image-20230420084400640](./assets/image-20230420084400640.png)
