 ...
 * <p>
 * 验证码案例
 * 1、生成随机 6 位验证码，放到 redis 中
 * 2、验证码 2 分钟有效->存放到 redis 中设置有效期 120 秒
 * 3、输入验证码验证，从 redis 中获取验证码和用户输入的对比
 * 4、每个手机号每天只能输入 3 次，通过 incr 发送一次加一，当大于 2 时提交不能发送
 */
public class Sms {
...
![image](C:/Users/zhongnan/Pictures/Camera Roll/image.3voo67if0pk0.webp)
...
![image](C:/Users/zhongnan/Pictures/Camera Roll/image.27g75i8u709w.webp)
