...
![image-20230429114104850](./assets/image-20230429114104850.png)
...
![img](./assets/20190124191110339.gif)
...
另外，如果 Referer 的判断逻辑写的不严密的话，也容易被攻破，例如
...
SameSite 有两种模式，Lax 跟 Strict 模式，默认启用 Strict 模式，可以自己指定模式：
